...
| **ExpirationDate** |            | `[DateTime]` | The expiration date for the connection will determine whether the RDP file should be 'Present' or 'Absent' |                |
